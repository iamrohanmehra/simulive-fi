...
/**
 * FIXED #3 & #38: Centralized Course interface
 * Represents a course from the Codekaro API
 */
...
/**
 * FIXED #3: Centralized UserData interface
 * Represents user data from external Codekaro API
 */
 ...
 * Note: id is optional when creating (Firestore auto-generates it)
 */
